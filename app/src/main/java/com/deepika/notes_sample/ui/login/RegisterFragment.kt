package com.deepika.notes_sample.ui.login
...
import com.deepika.notes_sample.databinding.FragmentRegisterBinding
import com.deepika.notes_sample.models.UserRequest
import com.deepika.notes_sample.utils.Helper.Companion.hideKeyboard
import com.deepika.notes_sample.utils.NetworkResult
import com.deepika.notes_sample.utils.TokenManager
        ...
        authViewModel.userResponseLiveData.observe(viewLifecycleOwner, Observer {
            ...
            when (it) {
                ...
                is NetworkResult.Error -> {
                    ...
                    //added dummy data
                    tokenManager.saveToken("token needs to be saved..")
                    findNavController().navigate(R.id.action_registerFragment_to_mainFragment)
                }
