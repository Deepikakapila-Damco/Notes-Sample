...
class NoteRepository @Inject constructor(private val noteAPI: com.deepika.notes_sample.api.NoteAPI) {
...
//            _notesLiveData.postValue(NetworkResult.Error(errorObj.getString("message")))
            _notesLiveData.postValue(NetworkResult.Error("No api are working"))
        } else {
